...
#             return False
    ...
    name = fields.Char(string="Patient's Name")
...
#     emp_code = fields.Char(string='Employee ID', states={'verified': [('readonly', True)]}, track_visibility="onchange")
    ...
    # partner_id = fields.Many2one('res.partner', string="Partner", required=False, rack_visibility="onchange", states={'verified': [('readonly', True)]})
