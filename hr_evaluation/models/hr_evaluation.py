...
class hr_evaluation_plan(models.Model):
...
class hr_evaluation_plan_phase(models.Model):
    ...
    _columns = {
        ...
        'company_id': fields.Many2one(related='plan_id.company_id', string='Company', store=True, readonly=True),
...
class hr_evaluation_interview(models.Model):
    ...
    _columns = {
        ...
        'user_to_review_id': fields.Many2one(related="evaluation_id.employee_id", string="Employee to evaluate"),
        ...
        'survey_id': fields.Many2one(string="Appraisal Form", relation="phase_id.survey_id"),
        # 'survey_id': fields.Related('phase_id', 'survey_id', string="Appraisal Form", type="many2one", relation="survey.survey"),
        'deadline': fields.Many2one(string="Deadline", relation="request_id.deadline"),
