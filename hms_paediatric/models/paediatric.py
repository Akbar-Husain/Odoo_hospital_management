...
#     m_delievery_details = fields.Selection(related="patient_id.m_delievery_details")
    pae_product_id = fields.Many2one('product.product', ondelete='restrict', string='Consultation Service', help="Consultation Services", domain=[('hospital_product_type', '=', "consultation_paediatric")], default=_get_pae_service_id, states={'cancel': [('readonly', True)], 'done': [('readonly', True)]})
