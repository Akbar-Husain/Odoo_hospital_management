...
#     # @api.depends('first_name','middel_name','last_name')
#     # @api.onchange('first_name','middel_name','last_name')
#     # def caps_name(self):
#     #     for rec in self:
#     #         if rec.first_name:
#     #             rec.first_name = str(rec.first_name).upper() or ''
#     #         if rec.middel_name:
#     #             rec.middel_name = str(rec.middel_name).upper() or ''
#     #         if rec.last_name:
#     #             rec.last_name = str(rec.last_name).upper() or ''
...
# #     _order='sequence,date_start,ranking_order desc'
...
#         for rec in self:
#             if rec.first_name:
#                 rec.first_name = str(rec.first_name).title() or ''
#             if rec.middel_name:
#                 rec.middel_name = str(rec.middel_name).title() or ''
#             if rec.last_name:
#                 rec.last_name = str(rec.last_name).title() or ''
    
#     @api.onchange('physician_id')
#     def onchange_doctor(self):
#         res = super(Appointment,self).onchange_doctor()
#         self.cabin_no = self.physician_id.cabin_no
#         return res

#     # @api.onchange('speciality')
#     # def onchange_speciality(self):
